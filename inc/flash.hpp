...
public:
	...
	static constexpr uint16_t PagesPerImage = 578;//Nombre de pages de mémoire par image
	static constexpr uint8_t FirstImagePageAddress = 99;//La page de la première image
	static constexpr uint16_t PageSize = 512;		//Nombre de bytes par pages
	static constexpr uint16_t MaxColumnCount = 256;	//Résolution X maximum du révolution
	 ...
	 *
	 * @param add : Adresse de la flash
	 * @param byte : Int à écrire (2 bytes)
	 */
	 ...
	 * Ex:  235 signifirait que les donnés à écrire dans la flash débuterait à 235e case du tableau (byte[235]).
	 */
	...
	/**
	 *
	 * @param imageNo : Le no de l'image à rendre disponible au carrousel.
	 *
	 * Cette méthode n'écrit pas l'image dans la flash.
	 */
	 ...
	 *
	 * Cette méthode n'éfface pas l'image dans la flash.
	 */
	 ...
	 * Si le carrousel est plein, l'image 0 sera écrasée.
	 */
